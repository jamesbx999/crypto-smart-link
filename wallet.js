// pages/api/wallet.js — Wallet deep link API
// GET /api/wallet?wallet=metamask&amount=10&chain=polygon
// Returns { deepLink, universalLink, eip681 }
...
export default function handler(req, res) {
  ...
  if (!walletDef) {
    return res.status(404).json({ error: `Unknown wallet: ${wallet}` });
  }
